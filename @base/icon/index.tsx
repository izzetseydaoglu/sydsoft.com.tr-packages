...
export const Icon: React.FC<Props> = ({ className, style, iconOzel, iconMui, ...other }) => {
    const ortakStyle: React.CSSProperties = {
        userSelect: "none",
        width: "1em",
        height: "1em",
    ...
    if (iconMui) {
        return (
            <span
                ...
                className={className ? className + " material-icons" : "material-icons"}
                aria-hidden="true"
                {...other}>
                {iconMui}
            </span>
            ...
            if (icon.full) {
                return (
                    <svg
                        ...
                        {...icon.attr}
                        {...other}
                        dangerouslySetInnerHTML={{ __html: icon.full }}
                    />
                );
            } else {
                return (
                    <svg
                        ...
                        <path fill={icon.fill || "currentColor"} d={icon.path} />
                    </svg>
                );
            }
        }
